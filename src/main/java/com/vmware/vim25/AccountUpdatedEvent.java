...
@XmlType(name = "AccountUpdatedEvent", propOrder = {"spec", "group", "prevDescription"})
public class AccountUpdatedEvent extends HostEvent {
  ...
  public void setPrevDescription(String paramString) {
    this.prevDescription = paramString;
  }
}

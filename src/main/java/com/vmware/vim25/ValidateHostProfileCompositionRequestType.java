...
@XmlType(name = "ValidateHostProfileCompositionRequestType", propOrder = {"_this", "source", "targets", "toBeMerged", "toReplaceWith", "toBeDeleted", "enableStatusToBeCopied", "errorOnly"})
public class ValidateHostProfileCompositionRequestType {
  ...
  public void setToReplaceWith(HostApplyProfile paramHostApplyProfile) {
    this.toReplaceWith = paramHostApplyProfile;
  }
  ...
  public void setErrorOnly(Boolean paramBoolean) {
    this.errorOnly = paramBoolean;
  }
}

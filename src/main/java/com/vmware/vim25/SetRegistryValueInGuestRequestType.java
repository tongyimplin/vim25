...
@XmlType(name = "SetRegistryValueInGuestRequestType", propOrder = {"_this", "vm", "auth", "value"})
public class SetRegistryValueInGuestRequestType {
  ...
  public void setValue(GuestRegValueSpec paramGuestRegValueSpec) {
    this.value = paramGuestRegValueSpec;
  }
}

...
@XmlType(name = "CreateVirtualDiskRequestType", propOrder = {"_this", "name", "datacenter", "spec"})
public class CreateVirtualDiskRequestType {
  ...
  public void setSpec(VirtualDiskSpec paramVirtualDiskSpec) {
    this.spec = paramVirtualDiskSpec;
  }
}
